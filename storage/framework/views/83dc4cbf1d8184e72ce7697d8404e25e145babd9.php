        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab01">
                    <?php echo $__env->make('message.objects', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo $__env->make('message.imagetext', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo $__env->make('message.upload_video', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    ...
                    <!-- 发送对象 -->
                        <div class="form-group">
                            <?php echo Form::label('objects', '发送对象', [
                        ...
                        <div class="form-group">
                            <?php echo Form::label('departmentId', '消息内容', [
                                'class' => 'col-sm-3 control-label'
                            ]); ?>
                                    ...
                                    <div class="tab-content" id="message-content">
                                        ...
                                        <div class="tab-pane" id="content_mpnews">
                                            ...
                                            <!--<div class="show_imagetext" style="width: 270px;border:1px solid #E4E6E9;border-radius: 4px;padding: 10px;position: relative;cursor: pointer;">
                                            	...
                                            	<div class="show_imagetext_pic" style="height: 125px;width: 250px;background-repeat: no-repeat;background-size:cover;background-image: url(<?php echo e(URL::asset('img/photo1.png')); ?>);"></div>
                                        ...
                                        <div class="tab-pane" id="content_sms">
                                        	<input id="content-sms-maxlength" type="hidden" value="<?php echo e($messageMaxSize); ?>" >
                                            <?php echo Form::textarea('content', null, [
                                                'id' => 'contentSms',
                                                'class' => 'form-control',
                                            ]); ?>
