...
<div class="multi-role">
        ...
        <div class="switchclass-head">
            ...
            <div class="weui-cell">
                <div class="weui-cell__bd title-name">
                    <input style="text-align: center;" id="classlist" class="weui-input" type="text" value="<?php if(!empty($scores)): ?> <?php echo e($scores[0]['classname']); ?> <?php endif; ?>"
                           readonly="" data-values="<?php echo e($scores[0]['class_id']); ?>">
                </div>
            </div>
    ...
    <div class="weui-cells" style="margin-top: 89px;">
        <?php $__currentLoopData = $scores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a class="weui-cell weui-cell_access" href='<?php echo e(url("wechat/score/detail?examId=".$s['id']."&classId=".$s['class_id'])); ?>'>
                <div class="weui-cell__bd">
                    <p><?php echo e($s['name']); ?></p>
                </div>
                <div class="weui-cell__ft time"><?php echo e($s['start_date']); ?></div>
            </a>
...
<script src="<?php echo e(URL::asset('js/fastclick.js')); ?>"></script>
<script>
    $(function() {
        FastClick.attach(document.body);
    });
</script>
<script src="<?php echo e(URL::asset('js/jquery-weui.min.js')); ?>"></script>
<script>
    var className = $.parseJSON('<?php echo e($className); ?>'.replace(/&quot;/g,'"'));
    var pageSize = '<?php echo e($pageSize); ?>';
    //班级列表
    $("#classlist").select({
        title: "选择班级",
        items: className
