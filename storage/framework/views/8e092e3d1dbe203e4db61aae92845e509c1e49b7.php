<?php echo $__env->make('score.send', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="help-block">下载<a href="<?php echo e(URL::asset('files/scores.xls')); ?>">模板</a></p>
                            </div>
                        </div>
                    </div>
                </div>
