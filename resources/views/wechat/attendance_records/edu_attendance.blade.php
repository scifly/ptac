...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('css/wechat/attendance_center/edu_index.css') }}">
<head>
<body ontouchstart>
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input style="text-align: center;" id="squad" name="squad" class="weui-input" type="text" value="" readonly="" data-values="">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label class="weui-label">选择规则</label></div>
					<div class="weui-cell__bd">
						<input style="text-align: center;" id="rule" name="rule" class="weui-input" type="text" value="" readonly="" data-values="">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd"><label for="date" class="weui-label">开始日期</label></div>
					<div class="weui-cell__bd">
						<input style="text-align: center;" class="weui-input" id="my-date" name="time" type="text" readonly="">
					</div>
				</div>
