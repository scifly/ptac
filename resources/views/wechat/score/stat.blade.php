...
@section('content')
	...
	<div class="scorelist">
		...
		<div class="scoreItem">
			...
			<div class="myscore"><span class="subject-title">得分</span><span class="scoredata">{{ $single['score'] }}</span></div>
			<div class="avescore"><span class="subject-title">均分</span>{{ $single['avg'] }}</div>
		</div>
		@endforeach
	</div>
