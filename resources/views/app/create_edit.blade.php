<div class="box box-widget">
    ...
    <div class="box-body">
        <div class="form-horizontal">
            @if (!empty($app['id']))
                {{ Form::hidden('id', null, ['id' => 'id', 'value' => $app['id']]) }}
            @endif
            ...
            @include('partials.enabled', ['enabled' => $app['report_location_flag'], 'label' => '是否打开地理位置上报'])
            @include('partials.enabled', ['enabled' => $app['isreportuser'], 'label' => '是否接收用户变更通知'])
            @include('partials.enabled', ['enabled' => $app['isreportenter'], 'label' => '是否上报用户进入应用事件'])
