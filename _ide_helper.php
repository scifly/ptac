...
namespace App\Facades { 
    ...
    class Wechat {
         ...
         * @static 
         */ 
        public static function getAccessToken($tokenFile, $corpId, $corpSecret)
        {
            return \App\Facades\Wechat::getAccessToken($tokenFile, $corpId, $corpSecret);
        }
         ...
         * @static 
         */ 
        public static function createUser($accessToken, $userId, $name, $mobile, $department, $order = null, $englishName = null, $position = null, $gender = null, $email = null, $isLeader = null, $enable = null, $avatarMediaId = null, $telephone = null, $extAttr = null)
        {
            return \App\Facades\Wechat::createUser($accessToken, $userId, $name, $mobile, $department, $order, $englishName, $position, $gender, $email, $isLeader, $enable, $avatarMediaId, $telephone, $extAttr);
        }
         ...
         * @static 
         */ 
        public static function updateUser($accessToken, $userId, $name = null, $mobile = null, $department = null, $order = null, $englishName = null, $position = null, $gender = null, $email = null, $isLeader = null, $enable = null, $avatarMediaId = null, $telephone = null, $extAttr = null)
        {
            return \App\Facades\Wechat::updateUser($accessToken, $userId, $name, $mobile, $department, $order, $englishName, $position, $gender, $email, $isLeader, $enable, $avatarMediaId, $telephone, $extAttr);
        }
         ...
         * @static 
         */ 
        public static function configApp($accessToken, $agentId, $reportLocationFlag = null, $logoMediaId = null, $name = null, $description = null, $redirectDomain = null, $isReportEnter = null, $homeUrl = null)
        {
            return \App\Facades\Wechat::configApp($accessToken, $agentId, $reportLocationFlag, $logoMediaId, $name, $description, $redirectDomain, $isReportEnter, $homeUrl);
        }
