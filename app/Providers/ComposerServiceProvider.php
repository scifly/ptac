...
class ComposerServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        $composers = [
            ...
            'custodian'              => ['index', 'create', 'edit', 'issue', 'permit'],
            'department'             => ['create_edit'],
            'educator'               => ['index', 'create', 'edit', 'issue', 'permit'],
            'event'                  => ['index', 'show'],
            ...
            'student'                => ['index', 'create', 'edit', 'issue', 'permit'],
        ...
        array_map(
            function ($type, $composers) {
                foreach ($composers as $dir => $views) {
                    ...
                    $dir != 'class' ? Inflector::camelize($dir) : $dir = 'Squad';
                    View::composer(
