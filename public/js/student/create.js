...
if (typeof crud === 'undefined') {
    $.getMultiScripts(['js/admin.crud.js'], page.siteRoot())
        .done(function() { crud.mobile('formStudent', 0, 'POST', 'students/store'); })
} else { crud.mobile('formStudent', 0, 'POST', 'students/store'); }
// 手机号
...
$(document).on('change', '#grade_id', function (e) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'json',
        url: page.siteRoot() + 'students/create?field=grade' + '&id=' + gradeId + '&_token=' + token,
