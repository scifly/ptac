...
$(document).on('click', '.btn-mobile-add', function (e) {
    ...
    $tbody.append(
        ...
        '<td style="text-align: center"><button class="btn btn-box-tool btn-add btn-mobile-add" type="button"><i class="fa fa-plus text-blue" title="新增"></i></button></td></tr>'
    );
    // icheck init
