...
/*var checkSwitcherState = function() {
    $('[data-click="check-switchery-state"]').on(
        "click",
        function() {
            alert($('[data-id="switchery-state"]').prop("checked"))
        }
    );
    $('[data-change="check-switchery-state-text"]').on(
        "change",
        function() {
...
/*var renderPowerRangeSlider = function() {
    if($('[data-render="powerange-slider"]').length!==0) {
        $('[data-render="powerange-slider"]').each(
            function() {
                var e = {};

                e.decimal = $(this).attr("data-decimal") ?
                    $(this).attr("data-decimal") : false;
                e.disable = $(this).attr("data-disable") ?
                    $(this).attr("data-disable") : false;
                e.disableOpacity = $(this).attr("data-disable-opacity") ?
                    $(this).attr("data-disable-opacity") : .5;
                e.hideRange = $(this).attr("data-hide-range") ?
                    $(this).attr("data-hide-range") : false;
                e.klass = $(this).attr("data-class") ?
                    $(this).attr("data-class") : "";
                e.min = $(this).attr("data-min") ?
                    $(this).attr("data-min") : 0;
                e.max = $(this).attr("data-max") ?
                    $(this).attr("data-max") : 100;
                e.start = $(this).attr("data-start") ?
                    $(this).attr("data-start") : null;
                e.step = $(this).attr("data-step") ?
                    $(this).attr("data-step") : null;
                e.vertical = $(this).attr("data-vertical") ?
